...
assert_eq(#payload.suppressed_ids, 2, "all suppressed ids remain available for field mutation")
assert_eq(payload.suppressed_ids[1], "b", "first suppressed id follows field order")
assert_eq(payload.suppressed_ids[2], "d", "second suppressed id survives killed sample truncation")
...
assert_eq(#single_choice.suppressed_ids, 0, "confirmation suppresses no field ids")
